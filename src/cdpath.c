...
/*   Updated: 2021/12/03 14:32:17 by fmonbeig         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static short	cdpath_check_every_path(t_data *data, char **cdpath, char **cmd, char *path)
{
	int	i;
...
short	cdpath(t_data *data, char **cmd)
{
	t_env	*temp;
	char	**cdpath;
	char	*path;
